...
class rigid(_constraint_force):
    ...
    def __init__(self):
        ...
        if not hoomd.context.exec_conf.isCUDAEnabled():
            ...
            self.cpp_force = _md.ForceComposite(hoomd.context.current.system_definition);#self.cpp_force = _md.ForceCompositeGPU(hoomd.context.current.system_definition);
